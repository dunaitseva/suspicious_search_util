...
cpplint_ignore="-build/c++11,-runtime/references,-whitespace/line_length,-legal/copyright,-readability/casting,-build/include_subdir,-runtime/indentation_namespace"
